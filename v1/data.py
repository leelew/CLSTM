...
def make_input_data(inputs, outputs, len_input, len_output, window_size):
...
def make_train_test_data(df, len_input, len_output, window_size):
    n = len(df)
    ...
    # FIXME:select proper data length to train model
    ...
    return train_x, train_y, test_x, test_y, \
        train_mean, train_std, normalized_test_x
